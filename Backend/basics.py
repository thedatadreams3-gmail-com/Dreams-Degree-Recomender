...
def home():
    ...
    all_course_keywords_tfidf = getCoursesTfidf(
        all_courses_tfidf, keywords_list)
    ...
    SP_course_results = []
    SP_course_results = getSpAndCoursesAndTfidfResults(
        SP_Course_Tuple, final_course_results)
